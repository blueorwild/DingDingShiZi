...
class SingleSelectPinyinPage extends StatefulWidget{
  @override
  createState() => new _SingleSelectPinyinPageState();
}

var singleSelectPinyinPageContext;

class _SingleSelectPinyinPageState extends State<SingleSelectPinyinPage> {
  ...
  // 根据要显示的文本的字数设置相应参数
  void setByTextLen(){
    int len = sspdSelectDetail.word[curWordIndex].length;
  ...
  void saveOrCancel() async {
    final response = await http.post('http://120.24.151.180:8080/api/record/collect_word?userId=' + userId +
        '&text=' + sspdSelectDetail.word[curWordIndex] + '&textbookName=' + sspdSelectDetail.textbookName[curWordIndex] +
        '&courseName='+ sspdSelectDetail.courseName[curWordIndex] + '&collect=' + (!isSave).toString());
    ...
    else alert(singleSelectPinyinPageContext, "网络连接失败");
  }
  ...
  void initState() {
    ...
    setVoice();
    setByTextLen();
    isSave = sspdSelectDetail.isSave[curWordIndex];
  }
  ...
  Widget build(BuildContext context) {
    singleSelectPinyinPageContext = context;
    return Scaffold(
      // 页面是个大container，个人习惯
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: sspdSelectDetail.word[curWordIndex].split('').map<Widget>((element) => Stack(  // 可堆叠式布局，自由度高，无限堆叠
                            ...
                            children: [
                              ...
                              if(isVisible)Container(
                                ...
                                width: textBoxWidth,
                                height: textBoxWidth*0.3,
                                child:Text(sspdSelectDetail.pinyin[curWordIndex].split(' ')[sspdSelectDetail.word[curWordIndex].split('').indexOf(element)],
                                  style: TextStyle(
                      ...
                      Container(
                        ...
                        child:Column(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: sspdSelectDetail.option[curWordIndex].map<Widget>((e) => Container(
                            alignment: Alignment(-1,-1),
                            width: deviceWidth * 0.5,
                            height: deviceHeight*0.055,
                            decoration: BoxDecoration(
                              color: isVisible ? (curSelectedWord == e ? (e == sspdSelectDetail.pinyin[curWordIndex] ?
                      ...
                      if(isVisible)Container(
                        ...
                        child:FlatButton(
                          ...
                          onPressed: () => playSound(sspdSelectDetail.pinyin[curWordIndex]),
                        ),
                      ),
                    ...
                    children:[
                      ...
                      SizedBox(
                        ...
                        child:FlatButton(
                          ...
                          onPressed:()=> setState(() {
                            if(curWordIndex == sspdSelectDetail.word.length - 1){
